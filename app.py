...
def df_to_pdf_table(df, title="FLASH"):
    ...
    table.setStyle(TableStyle([
        ('BACKGROUND', (0, 0), (-1, 0), colors.HexColor("#FFF9C4")),  # لون العنوان
...
if uploaded_files:
    # تسجيل الخطوط العربية Noto Naskh Arabic
    pdfmetrics.registerFont(TTFont('Arabic', 'NotoNaskhArabic-Regular.ttf'))
    pdfmetrics.registerFont(TTFont('Arabic-Bold', 'NotoNaskhArabic-Bold.ttf'))
